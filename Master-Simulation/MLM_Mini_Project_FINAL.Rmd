...
e. What is the total sample size $N$ used in the model fit? **comment**
    ...
    Response: The total sample size $N$ is `r scales::comma(length(summary(lme3)$residuals))` which is expected as the mean of our predictor is `r round(mean(dat$predictor), 3)`.
