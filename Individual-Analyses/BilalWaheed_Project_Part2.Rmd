...
i. In which year is there more between school variation, net of all else, **(you should comment)**?
    ...
    Response: 
  In year 1 there is more between school variation.
...
* V_S(year = 0) = $\sigma^2_{\zeta_0} + 0^2 \sigma^2_{\zeta_1} + 2\cdot0\cdot Cov(\sigma^2_{\zeta_0},\sigma^2_{\zeta_1}) = \sigma^2_{\zeta_0} = 370.6$
* V_S(year = 1) =

$$\sigma^2_{\zeta_0} + 1^2 \cdot \sigma^2_{\zeta_1} + 2\cdot1\cdot Cov(\sigma^2_{\zeta_0},\sigma^2_{\zeta_1}) = $$
$$\sigma^2_{\zeta_0} + \sigma^2_{\zeta_1} + 2\cdot \sigma_{\zeta_0} \cdot \sigma_{\zeta_1} \cdot \rho(\sigma^2_{\zeta_0}, \sigma^2_{\zeta_1}) = $$
