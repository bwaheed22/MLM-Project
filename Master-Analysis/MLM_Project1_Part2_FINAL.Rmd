...
```
    ...
    Response: 
  The density and QQ-plots of the random effects for schools and classrooms ($\zeta_0$ and $\eta_0$) show evidence of normality, with some concern in the left and right tails of the QQ-plots of both random effects. Additionally, Shapiro Wilks test fails to reject the null of non-normality for both ($\zeta_0$ and $\eta_0$).
...
# sm::sm.density(resFE_RE, model = 'normal')
...
```
    ...
    Response: 
  The density & Q-Q plots of the individual level residuals appears to be symmetric and normal. However, the BLUPs do not show evidence of normality, with erratic density and qq-plots. Shapiro Wilks test reject the null of non-normality for both ($\zeta_0$ and $\zeta_1$)
  
  <!-- Additionally, Shapiro Wilks test fails to reject the null of non-normality for both ($\zeta_0$ and $\eta_0$). -->
