...
> Minority random slope when allowing for correlation between random slope and random intercept is statistically significant but 0.00 when not allowing for correlation
...
### b. In the last model, what is a “likely” (+/- 1 sd) range for \(\eta\)~0jk~
    ...
    Response:  80.62   8.979 

### c. Can we make a similar statement about \(\zeta\)~0k~?

    Response: No, because of three different SDs - 
